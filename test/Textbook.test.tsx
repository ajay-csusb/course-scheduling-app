...
describe('Textbook', () => {
  ...
  test('Palm desert bookstore link', () => {
  ...
  test('laboratory catalog number', () => {
    textbook.catalogNumber = '4000L';
    expect(textbook.link()).toEqual(
      'https://www.bkstr.com/webApp/discoverView?bookstore_id-1=1101&term_id-1=111&div-1=&dept-1=foo&course-1=4000L&section-1=04'
    );
  })
