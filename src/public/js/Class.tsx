...
export class Class {
  ...
  static transformToClass(object: any): IClass {
    const result: IClass = {
      ...
      courseAttrDescription: object.crse_ATTR_VALUE_DESCR.trim(),
      ...
      fullSsrComponent: object.ssr_COMPONENT_DESCR.trim(),
      ...
      longDescription: object.descrlong_VC.trim(),
      ...
      title: object.course_TITLE_LONG.trim(),
